    ...
    <header className="h-20 bg-white border-b border-slate-200 flex items-center justify-between px-8 sticky top-0 z-40">
      ...
      <div className="flex items-center gap-6">
        <div className="flex items-center gap-4 border-r border-slate-100 pr-6 mr-2">
          <div className="relative p-2 rounded-full hover:bg-slate-50 cursor-pointer text-slate-500">
            <Bell size={20} />
            <span className="absolute top-2 right-2 w-2 h-2 bg-red-500 border-2 border-white rounded-full"></span>
          </div>
          <div className="p-2 rounded-full hover:bg-slate-50 cursor-pointer text-slate-500">
